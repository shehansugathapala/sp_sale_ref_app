...
class _CustomerRegistrationState extends State<CustomerRegistration> {
  ...
  Future<void> _createCustomer() async {
    ...
    final customerDoc = await FirebaseFirestore.instance.collection('customers').doc(businessNameCtrl.text + '_' + LoginSession.refName);
  ...
  void _getCustomer(String businessName, String refName) async {
    ...
    return Scaffold(
      ...
      floatingActionButton: SpeedDial(
        ...
        children: [
          ...
          SpeedDialChild(child: const Icon(Icons.done), label: 'Save Customer', onTap: () => _createCustomer),
        ],
      ),
    );
  }
  ...
  void _openCustomerSheet(context) {
    showModalBottomSheet(
        ...
        builder: (BuildContext bc) {
          return CustomerRegBottomSheetScreen(selectCustomer: _getCustomer);
        });
  }
}
