...
class LoadItemsTileWidget extends StatefulWidget {
  const LoadItemsTileWidget({Key? key, required this.product, required this.index}) : super(key: key);
  final List<LoadedProducts> product;
  final int index;

  //final Function(BuildContext context, LoadedProducts loadedProducts) viewUpdateSheet;

  @override
  State<LoadItemsTileWidget> createState() => _LoadItemsTileWidgetState();
}

class _LoadItemsTileWidgetState extends State<LoadItemsTileWidget> {
